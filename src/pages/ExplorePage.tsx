...
const ExplorePage = () => {
  ...
  return (
    <DashboardLayout>
      ...
      {/* Right Sidebar */}
      <aside className="hidden lg:block w-72 lg:h-[calc(100vh-65px)] sticky top-[65px] border-l border-[#334155]/30 bg-gradient-to-br from-[#1e293b]/50 to-[#0f172a]/30 overflow-y-auto p-6">
